...
// GetColumns returns the info of columns of specified table
// SELECT COLUMN_NAME,DATA_TYPE,COLUMN_KEY,IS_NULLABLE,COLUMN_TYPE,COLUMN_COMMENT
// FROM information_schema.COLUMNS WHERE TABLE_SCHEMA = 'blog_service' AND TABLE_NAME = 'blog_article';
